-- ULTRA SAFE SAAS MIGRATION SCRIPT
-- Dit script migreert de bestaande database naar multi-tenant SaaS
-- Controleert alles voordat het wijzigingen maakt

-- ==============================================
-- STAP 1: CREATE ORGANIZATIONS TABLE (IF NOT EXISTS)
-- ==============================================
...
-- ==============================================
-- STAP 4: INSERT PP ORGANIZATION (SAFELY)
-- ==============================================

-- Insert Poule & Poulette organization only if it doesn't exist
DO $$
BEGIN
    -- Check if PP organization already exists
    IF NOT EXISTS (SELECT 1 FROM organizations WHERE slug = 'pp') THEN
...
-- ==============================================
-- STAP 5: SAFELY ADD ORGANIZATION COLUMNS
-- ==============================================
...
-- ==============================================
-- STAP 6: MIGRATE EXISTING DATA (SAFELY)
-- ==============================================
...
-- ==============================================
-- STAP 7: CREATE INDEXES FOR PERFORMANCE
-- ==============================================
...
-- ==============================================
-- STAP 8: SETUP ROW LEVEL SECURITY (RLS)
-- ==============================================
...
-- ==============================================
-- STAP 9: CREATE HELPER FUNCTIONS
-- ==============================================
...
-- ==============================================
-- STAP 11: CREATE VIEWS FOR ANALYTICS
-- ==============================================

-- =====================================================
-- STORAGE BUCKET RLS FIX - ANON ACCESS
-- =====================================================
-- Dit script fix de RLS policies zodat anon users
-- (via anon key) foto's kunnen uploaden en bekijken
...
-- 7. Toon alle policies voor audit-photos bucket
SELECT 
  schemaname,
  tablename,
  policyname,

-- Poule & Poulette Interne Audit Tool - Production Database Schema
-- Dit schema is klaar voor productie deployment in Supabase
...
DO $$ BEGIN
    CREATE TYPE user_role AS ENUM ('admin', 'coo', 'district_manager', 'filiaal_manager', 'user');
EXCEPTION
...
CREATE TABLE gebruikers (
    ...
    created_by UUID REFERENCES gebruikers(id) ON DELETE SET NULL,
...
BEGIN
    ...
    -- Medium urgency for medium scores or medium-weight items

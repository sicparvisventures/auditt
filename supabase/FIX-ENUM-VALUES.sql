-- Poule & Poulette Interne Audit Tool - Fix Enum Values
-- This script fixes the user_role enum to include the correct values
...
-- STAP 2: Add missing enum values
DO $$ 
BEGIN
...
SELECT 'Enum values fixed successfully. Available roles: admin, inspector, manager' as status;

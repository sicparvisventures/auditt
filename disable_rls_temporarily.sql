...
-- ONLY use this for localhost testing!
...
-- Insert seed data again (in case it wasn't inserted before)
...
SELECT user_id, naam, rol FROM gebruikers LIMIT 5;

SELECT 'SAMPLE FILIALEN:' as info;
SELECT naam, locatie FROM filialen LIMIT 5;
